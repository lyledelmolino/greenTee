...
export class LoginComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.greenTee918Service.castLoginFormComponentVisibility
            .subscribe(visibility => { this.loginFormComponentVisible = visibility;
            });

        this.greenTee918Service.castForgotPasswordComponentVisibility
            .subscribe(visibility => { this.forgotPasswordComponentVisible = visibility; });

        this.greenTee918Service.castPasswordResetEmailComponentVisibility
            .subscribe(visibility => { this.passwordResetEmailComponentVisible = visibility; });

        this.greenTee918Service.castPasswordResetPhoneComponentVisibility
            .subscribe(visibility => { this.passwordResetPhoneComponentVisible = visibility; });
